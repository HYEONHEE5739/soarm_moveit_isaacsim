...
def generate_launch_description():
    ...
    moveit_config = (
        ...
        .robot_description(file_path=real_xacro)
    ...
    # Move Group (with real hardware backend)
    add_launch_description(
        ld,
    ...
    # ros2_control_node
    # so101_real.urdf.xacro includes so101_real.ros2_control.xacro
    # which uses so_arm_hardware/SoArmSystem plugin
    ld.add_action(
        Node(
